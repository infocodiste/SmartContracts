...
contract NowLamboBNB is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for BNB
        swapTokensForEth(tokenAmount); // <- this breaks the BNB -> HATE swap when swap+liquify is triggered
        ...
        // transferring BNB to marketingDevWallet
    ...
    function initializeLiquidity(uint256 tokenAmount) public virtual lockTheSwap payable {
        require(msg.value > 0, "SwapAndLiquify::initialize: insufficient bnb");
